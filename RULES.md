...
- Each team's base Attack and Defense come from weighted player overalls. Advanced slots weigh more for Attack, deeper slots weigh more for Defense, and elite players use a stronger exponential quality curve so the gap between a 70, 80 and 90 overall player is visible in ratings, goals, assists, saves and penalties.
...
- Morale Dynamic has two layers. Persistent morale carries recent results into the next match (-1 to +1). In the final group match, the engine also calculates qualification pressure from current points, rank and goal difference: a must-win team gets a modest urgency/composure lift and slightly higher match volatility, but the result is still sampled normally.
- Style matchups add small edges. Defensive is good against Counter but bad against Possession and slightly bad against Gegenpress. Balanced has no major bad matchup and small stability edges. Gegenpress is good against Possession and Defensive but bad against Counter. Possession is good against Defensive but bad against Gegenpress and Counter. Counter is good against Gegenpress and Possession but bad against Defensive. Wing Play is good against Defensive and Compact but bad against Possession and Gegenpress. Compact Midfield is good against Gegenpress and Counter but bad against Wing Play and Possession.
